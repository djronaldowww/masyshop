...
echo $conteudo."<hr>";
?>
<a href="produtos.php?id=<?php echo $linha['id'];?>"><?php echo $linha['titulo'];?></a><br>
...
$max_links=3;
echo "<a href=\"listar_produtos.php?pagina=1\">primeira</a>";

for($pag_anterior=$pagina-$max_links; $pag_anterior<=$pagina-1; $pag_anterior++){
if($pag_anterior>=1){
    echo "<a href=\"listar_produtos.php?pagina=$pag_anterior\">$pag_anterior</a>";
}}
...
for($pag_posterior=$pagina+1;$pag_posterior<=$pagina+$max_links;$pag_posterior++){
    if($pag_posterior<=$quantidade_pg){
        echo "<a href=\"listar_produtos.php?pagina=$pag_posterior\">$pag_posterior</a>";
    }
}

echo "<a href=\"listar_produtos.php?pagina=$quantidade_pg\">ultima</a>";
?>
</body>
</html>