...
<div class="centro">
<div class="crud">
<a href="add_artigo.php" class="adicionar">Adicionar</a>
</div>
<br>
<center>
<div id="topo"></div>
...
?>
<div class="crud">
        <a href="usuarios.php?id=<?php echo $id;?>" class="visualiza">Visualizar</a>
        <a href="edd_usarios.php?id=<?php echo $id;?>" class="editar">Editar</a>
        <a href="ex_usuarios.php?id=<?php echo $id;?>" class="excluir">Excluir</a>
        </div>
<?php endforeach?>
</div>
</center>
