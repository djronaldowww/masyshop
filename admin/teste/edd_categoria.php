...
<div class="centro">
<div class="crud">
<a href="add_categoria.php" class="adicionar">Adicionar</a>
</div>
<center>
<div id="topo"></div>
...
?>
<div class="crud">
        <a href="categoria.php?id=<?php echo $id;?>" class="visualiza">Visualizar</a>
        <a href="ex_categoria.php?id=<?php echo $id;?>" class="excluir">Excluir</a>
        </div>
<?php endforeach?>
</div>
</center>
