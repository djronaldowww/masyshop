...
<?php echo $id; ?>-<?php echo $titulo; ?><br>
        ...
        <div class="crud">&nbsp;&nbsp;
        <a href="artigo.php?id=<?php echo $id;?>" class="visualizar">Visualizar</a>
        <a href="edd_artigo.php?id=<?php echo $id;?>" class="editar">Editar</a>
        <a href="ex_artigo.php?id=<?php echo $id;?>" class="excluir">Excluir</a>
        </div>
</td></tr></table>
    <br><hr><br>
</div>
